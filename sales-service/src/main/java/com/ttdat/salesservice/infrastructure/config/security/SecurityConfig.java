package com.ttdat.salesservice.infrastructure.config.security;

import com.ttdat.salesservice.infrastructure.filters.JwtBlacklistFilter;
...
public class SecurityConfig {
    ...
    private final SalesServiceAuthenticationEntryPoint salesServiceAuthenticationEntryPoint;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .oauth2ResourceServer(oauth2 ->
                        ...
                        ).authenticationEntryPoint(salesServiceAuthenticationEntryPoint))
