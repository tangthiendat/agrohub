...
import com.ttdat.customerservice.infrastructure.filters.JwtBlacklistFilter;
...
public class SecurityConfig {
    ...
    private final CustomerServiceAuthenticationEntryPoint customerServiceAuthenticationEntryPoint;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .oauth2ResourceServer(oauth2 ->
                        ...
                        ).authenticationEntryPoint(customerServiceAuthenticationEntryPoint))
