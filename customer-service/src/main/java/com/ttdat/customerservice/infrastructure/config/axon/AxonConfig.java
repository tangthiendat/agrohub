package com.ttdat.customerservice.infrastructure.config.axon;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.fasterxml.jackson.databind.SerializationFeature;
import com.fasterxml.jackson.datatype.jsr310.JavaTimeModule;
import com.ttdat.customerservice.application.handlers.error.CustomerServiceEventErrorHandler;
import com.ttdat.customerservice.infrastructure.interceptors.MetadataDispatchInterceptor;
        ...
        return configurer -> configurer.eventProcessing(processingConfigurer ->
                        processingConfigurer
                                .registerDefaultListenerInvocationErrorHandler(
                                        conf -> new CustomerServiceEventErrorHandler()
                                )
        );
    }
