...
@Component
public class CustomerServiceAuthenticationEntryPoint implements AuthenticationEntryPoint {
    private final AuthenticationEntryPoint delegate = new BearerTokenAuthenticationEntryPoint();
    private final ObjectMapper mapper;

    public CustomerServiceAuthenticationEntryPoint(ObjectMapper mapper) {
        this.mapper = mapper;
    }
