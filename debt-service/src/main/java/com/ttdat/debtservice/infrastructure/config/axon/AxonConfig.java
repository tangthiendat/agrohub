package com.ttdat.debtservice.infrastructure.config.axon;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.fasterxml.jackson.databind.SerializationFeature;
import com.fasterxml.jackson.datatype.jsr310.JavaTimeModule;
import com.ttdat.debtservice.application.handlers.error.DebtServiceEventErrorHandler;
import com.ttdat.debtservice.infrastructure.interceptors.MetadataDispatchInterceptor;
        ...
        return configurer -> configurer.eventProcessing(processingConfigurer ->
                        processingConfigurer
                                .registerDefaultListenerInvocationErrorHandler(
                                        conf -> new DebtServiceEventErrorHandler()
                                )
        );
    }
